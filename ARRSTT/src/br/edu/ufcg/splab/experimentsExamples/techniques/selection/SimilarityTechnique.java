...
import br.edu.ufcg.splab.experimentsExamples.util.matrix.Matrix;
import br.edu.ufcg.splab.experimentsExamples.util.matrix.SimilarityStructure;
 ...
 *
 */
public class SimilarityTechnique implements InterfaceSelectionTechnique {
	private Matrix matrix;

	public SimilarityTechnique() {
