...
import br.edu.ufcg.splab.experimentHierarchy.util.BranchSeparator;
import br.edu.ufcg.splab.experimentHierarchy.util.ExperimentFile;
...
public class TeamExperiment {
	...
	public void runExperiment() throws Exception {
		...
		for(ExecutableTreatment combination : combinations) {
			...
			TestSuite testSuite = combination.execute();
